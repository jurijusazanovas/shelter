...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
		...
		wp_register_script('jquery', ASSETS_URL . '/assets/scripts/jQuery.js', array(), false, true);
		wp_register_script('slick', ASSETS_URL . '/assets/scripts/slick.js', array('jquery'), false, true);
		wp_register_script('custom', ASSETS_URL . '/assets/scripts/custom.js', array('slick'), false, true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('slick', ASSETS_URL . '/assets/css/slick.css', array(), false, 'all');
		wp_register_style('slick-theme', ASSETS_URL . '/assets/css/slick-theme.css', array('slick'), false, 'all');
		wp_register_style('style', ASSETS_URL . '/assets/css/style.css', array('slick-theme'), false, 'all');
